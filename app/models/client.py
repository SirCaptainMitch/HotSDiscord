...
from app.functions.reddit import *
from app.functions.findTexts import *
...
class Client(discord.Client):
    ...
    async def on_raw_reaction_add(self, payload):
        ...
        if message.author.id == DiscordUserIDs['Probius'] and str(payload.emoji) == '👎':
            ...
            return
        # not sure how I feel about this one, it doesn't really serve a purpose that I can think off.. 
